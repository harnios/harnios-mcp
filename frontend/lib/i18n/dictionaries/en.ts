...
export const en: Dictionary = {
  chat: { open: "Open chat", close: "Close chat", title: "Harnios assistant", placeholder: "Ask Harnios…", send: "Send", thinking: "Thinking…", error: "Something went wrong.", maximize: "Maximize chat", restore: "Restore chat", toolRunning: "Running tool", toolComplete: "Tool completed", toolFailed: "Tool failed", toolPending: "Waiting", toolInput: "Request", toolResult: "Result", stop: "Stop", reset: "Reset chat", modeLabel: "Chat mode", modeHarnios: "Harnios", modeGeneral: "General", modeLocked: "Wait for the current operation to finish before changing mode" },
  init: {
