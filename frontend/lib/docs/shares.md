...
From the file editor, use **Share temporarily** to create a read-only browser link for one file.

- Every link expires automatically; choose 1 hour, 1 day, 7 days, or 30 days.
